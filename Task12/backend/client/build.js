...
/***/ function(module, exports, __webpack_require__) {
	...
	var _feedPage = __webpack_require__(6);
	...
	(0, _jquery2.default)("#page").html((0, _index2.default)({}));
	...
	exports.default = _backbone.Router.extend({
	  ...
	  navigateFeeds: function navigateFeeds() {
	    ...
	    (0, _jquery2.default)("#page").append(this.$el);
	    this.oldView = new _feedPage2.default({ el: this.$el });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _backbone.Collection.extend({
	  ...
	  comparator: "date",
	  url: function url() {
	    return "http://127.0.0.1:4000/api/posts";
	  }
	});
